...
class CrfTokenizer(BaseTokenizer):
    def __init__(self, config_root_path="/home/komatsu/code/vnese-word-tokenize/core_nlp/tokenization/", bi_grams_path='bi_grams.txt', tri_grams_path='tri_grams.txt',
