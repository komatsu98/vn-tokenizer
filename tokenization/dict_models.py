...
class LongMatchingTokenizer(BaseTokenizer):
    def __init__(self, bi_grams_path='/home/komatsu/code/vnese-word-tokenize/core_nlp/tokenization/bi_grams.txt', tri_grams_path='/home/komatsu/code/vnese-word-tokenize/core_nlp/tokenization/tri_grams.txt'):
        """
        Initial config
